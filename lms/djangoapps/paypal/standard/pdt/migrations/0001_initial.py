...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paypal_pdt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('business', self.gf('django.db.models.fields.CharField')(max_length=127, blank=True)),
            ('charset', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('receiver_email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
            ('receiver_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('txn_id', self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, blank=True)),
            ('txn_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('address_status', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('auth_status', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('payer_status', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('payment_status', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('payment_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('pending_reason', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('protection_eligibility', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True)),
            ('reason_code', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('transaction_entity', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('payment_cycle', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('period_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('product_name', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('product_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('profile_status', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('recurring_payment_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('period1', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('period2', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('period3', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('mp_id', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ...
            ('case_type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('receipt_id', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('ipaddress', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39, null=True, blank=True)),
            ...
            ('amt', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=64, decimal_places=2, blank=True)),
            ('cm', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('sig', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('tx', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('st', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
        ))
